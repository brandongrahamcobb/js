function main(){
  ...
  style.href = '/home/spawd/Documents/css/CobbBrandonGraham_css_240724.css';
...
//  app.style.justifyContent = 'center';
  ...
  // Hide the custom cursor when not moving for better performance
  document.addEventListener('mouseleave', function() {
      cursor.style.display = 'none';
  });
  document.body.appendChild(cursor)
  // Add event listeners for link hover to change cursor to GIF
...
//  document.body.appendChild(image)
  ...
  links.forEach(function(link) {
      link.addEventListener('mouseenter', function() {
          cursor.style.backgroundImage = 'url("/home/spawd/Documents/html/cursor.gif")'; // Change background to GIF on link hover
      });
     link.addEventListener('mouseleave', function() {
          cursor.style.backgroundImage = 'url("/home/spawd/Documents/html/aero_arrow.cur")'; // Revert to animated cursor on leaving link
      });
  });
